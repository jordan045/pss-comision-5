...
export default function CargarNotasParcialesPage() {
    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 bg-gray-50">
      ...
      <div className="w-full max-w-5xl bg-white p-6 md:p-8 rounded-lg shadow-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-semibold">Cargar Notas Parciales</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <Label htmlFor="cursada">Cursada (Código)<span className="text-red-500">*</span></Label>
                <Input id="cursada" placeholder="Campo de texto vacío" />
              </div>
            </div>
              ...
              <div>
                ...
                <Select defaultValue="borrador">
                  <SelectTrigger id="estado">
                    <SelectValue placeholder="Listado de estados de nota" />
                  </SelectTrigger>
                  <SelectContent>
